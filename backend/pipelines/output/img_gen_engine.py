...
_TEMPLATE_PATH = os.path.join(_BACKEND_DIR, "data", "photos", "polaroid_template.png")

API_KEY = os.getenv("IMG_GEN_API_KEY", "")
API_URL = "https://dashscope.aliyuncs.com/api/v1/services/aigc/multimodal-generation/generation"
MODEL = "wan2.7-image-pro"

PROMPT = "将第二张照片中的人完整提取出来，以第一张图的艺术风格重新绘制后，替换掉第一张图右侧区域的人。保持第一张图的卡片设计、背景、文字布局完全不变。人物的面部特征、发型、衣服颜色和款式与第二张照片保持一致。"
...
async def generate_portrait_card(
    ...
    output_dir: str = os.path.join(_BACKEND_DIR, "data", "photos"),
) -> str | None:
    ...
    try:
        ...
        # 读取模板尺寸，保持输出比例一致
        tmpl = Image.open(_TEMPLATE_PATH)
